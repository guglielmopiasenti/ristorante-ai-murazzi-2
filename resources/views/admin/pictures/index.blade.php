...
@section('title', 'Menu')
@section('content')
    <div x-data="{ openDeleteModal: false, openCreatePlate: false, pictureId: null }">
            ...
            <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <div class="grid grid-cols-2 items-center">
                    ...
                    <div class="w-auto justify-self-end">
                        <button @click="openCreatePlate = true" x-transition type="button"
                            class="rounded-full border border-transparent bg-indigo-600 px-4 py-2 font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Aggiungi una foto
                        </button>
                        <template x-if="openCreatePlate" x-cloak>
                            @include('includes.add-picture')
                        </template>
                    </div>
                </div>
                ...
                <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    @forelse ($pictures as $picture)
                        <div class="group relative grid grid-cols-1">
                            <div
