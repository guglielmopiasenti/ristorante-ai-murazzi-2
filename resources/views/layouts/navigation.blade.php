<nav x-data="{ open: false }" class="bg-gray-950 sticky top-0 z-10 glass-navbar backdrop-blur-sm bg-opacity-60">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('admin.dishes.index') }}">
                        {{ __('Menu') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('admin.pictures.index') }}">
                        {{ __('Foto') }}
                    </x-nav-link>
                </div>
            </div>
